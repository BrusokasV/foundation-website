    ...
    return (
        ...
        <section className="py-2 text-center container">
            ...
            <div className="col-lg-6 col-md-8 mx-auto">
                ...
                <p>
                <a href="#" className="btn btn-outline-blood-red my-2">Make a donation</a>
                </p>
            </div>
            </div>
        </section>
        ...
        <footer class="text-body-secondary py-5">
            <div class="container">
                ...
                <p class="mb-1">Contact The Messerschmidt Foundation:</p>
                <p class="mb-0">Address: 1 Rue Revanche, 1969 Kirchberg Luxemburg, Luxembourg</p>
                <p class="mb-0">Email: tomas.messerschmidt@gmail.lu</p>
            </div>
        </footer>
